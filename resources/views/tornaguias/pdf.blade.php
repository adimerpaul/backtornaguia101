...
<table style="width:100%;">
  <tr>
  <td>
      <p style="color:#639f93;display:inline;">Fecha:</p> {{$tornaguia->fecha_tornaguia}} 
  </td>
  <td>
  ...
  <p style="color:#639f93;display:inline;">Yacimiento:</p><?php $q=App\Models\Contratista::select('*')->where('id',$tornaguia->id_contratista)->first(); ?> {{ $tornaguia->yacimiento }}<br>
  <p style="color:#639f93;display:inline;">Cuadrilla:</p> {{ $tornaguia->cuadrilla }}<br>
