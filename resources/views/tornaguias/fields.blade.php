<div class="form-group col-sm-6">
    {!! Form::label('id_empresa', 'Fecha de Tornaguia:') !!} {!! date('d') !!} / {!! date('m') !!} / {!! date('Y') !!} <br>
    {!! Form::date('fecha_tornaguia', null,['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    {!! Form::label('Cuadrilla', 'Cuadrilla:') !!}
  
    {!! Form::text('cuadrilla', null, ['class' => 'form-control','maxlength' => 30,'maxlength' => 30,'style' => 'text-transform:uppercase']) !!}
	<!--input type="hidden" id="yacimiento" name="yacimiento" value=""-->
</div>
<div class="form-group col-sm-6">
&nbsp;
...
<div class="form-group col-sm-6">
    ...
    {{ Form::radio('tipo_manterial', 'broza' , false, ['onchange'=> 'handleChange(this)']) }}  Broza
    {{ Form::radio('tipo_manterial', 'embolsado' , false, ['onchange'=> 'handleChange(this)']) }} Embolsado
</div> 
...
<script>
/*
       // let result = document.querySelector('#tipo_manterial');
        var result = document.myForm.tipo_manterial;
...
*/
    function handleChange(src) {
       // alert(src.value);
        if (src.value=='broza')  str = "Zn,Ag,Pb";
        if (src.value=='embolsado')  str = "Sn";
        //str+= $(this).val()+",";
        
        $('#minerales').val(str.substring(0, str.length));
     }
    </script>