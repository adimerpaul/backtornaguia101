...
<table style="width:100%;">
  <tr>
  <td style="border-top: -35px white solid;">
  ...
  <tr>
  <td style="border-top: 15px white solid;">
  ...
  <td style="border-top: 5px white solid; border-left:-100px;">
  ...
  <br>
  <p style="font-size:14px;display:inline;">{{ $q->nombre }}</p> 
  </td>
  </tr>
  <tr>
  <td style="text-align:center; color: white; background-color: #FFF;; font-size:20px;">
  ...
  <td style="text-align:center; color: white; background-color: #FFF;; font-size:13px;">
      TIPO DE MATERIAL:
  </td>
  </tr>
  <tr>
  <td>
  <p style="color:#FFF;;display:inline;">Tipo de Trans:</p> <?php $t=App\Models\Transporte::select('*')->where('id',$tornaguia->id_transporte)->first(); echo $t->tipo_transporte; ?><p style="color:#FFF;;display:inline;">     Marcaaaaaaa:</p>{{ $t->marca }}  <br>
  <p style="color:#FFF;;display:inline;">Colooooooooor:</p>{{ $t->color }} <p style="color:#FFF;;display:inline;">Placaaaaaaaa: </p> {{ $t->placa }} <br>

  <p style="color:#FFF;display:inline;text-align:center;">Linea en blanco 1</p><br>
...
<p style="color:#FFF;border-left:30px;border-top:-60px;">   Tipo de Material: </p>@if($tornaguia->tipo_manterial =="broza")  X  @else  Y   @endif  <br>  
  ...
  <p style="color:#FFF;border-left:-30px;display:inline;">    Cantidad de Sacos:</p>{{ $tornaguia->sacos }}  <br>
  </td>
  </tr>
  <tr>
  <td colspan=2>
